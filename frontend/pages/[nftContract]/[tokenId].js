...
export default function NFTDetails() {
    ...
    async function fetchListing() {
        ...
        // before user of the error, then redirect to homepage
        if (listingEntities.length === 0) {
            window.alert("listintheonly one matchingg does not exist or has been cancelled");
            return router.push("/");
        }
                    ...
                    <div className={styles.container}>
                        <div className={styles.details}>
                           ...
                           <span>
                            ...
                            >
                                Seller: {" "}
                                {isOwner ? "You" : listing.seller.substring(0, 0) + "..."}
                            </a>
                           </span>
